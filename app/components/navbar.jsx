        ...
        <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <button onClick={()=> setIsDarkMode(prev => !prev)}>
                    <Image src={isDarkMode ? assets.sun_icon : assets.moon_icon} alt='moon icon' className='size-6 mr-1'></Image>
                </button>
                ...
                <button className='block md:hidden ml-3' onClick={openMenu}>
                    <div>
                        <Image src={isDarkMode ? assets.menu_white : assets.menu_black} alt='moon icon' className='size-5 mr-2.5'></Image>
                    </div>
                </button>
            ...
            <div className='absolute right-6 top-6' onClick={closeMenu}>
                <Image src={isDarkMode ? assets.close_white : assets.close_black} alt='close_black' className='w-5 cursor-pointer'></Image>
            </div>
