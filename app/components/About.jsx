    ...
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-8'>
            ...
            <div className='flex-1'>
                <p className='mb-10 max-w-2xl'>I have a passion to learn anything in technology. I enjoy working on hands-on projects that enhance my skills. Currently, I'm exploring cloud computing, windows server, and more!</p>
                ...
                <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                    {infoList.map(({icon, iconDark, title, description}, index)=>(
                        <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50' key={index}>
                            ...
                            <h3 className='my-4 text-gray-700 headerFont text-2xl dark:text-white'>{title}:</h3>
                            <p className='text-gray-600 text-sm dark:text-white/80'>{description}</p>
                        </li>
                    ))}
                </ul>
                <h4 className='my-6 text-gray-700 headerFont text-2xl dark:text-white/80'>Tools I use:</h4>
